                        ...
                        <form className="form">
                            ...
                            <div className="credit-card-info--form">
                                <div className="input_container">
                                    <label style={{ color: errorMessage.card_holder_name ? 'red' : '' }}>
                                ...
                                <div className="input_container">
                                    <label style={{ color: errorMessage.card_number ? 'red' : '' }} >
                                        Card Number
                                    </label>
                                    <input
                                       style={{ width: '100%', borderColor: errorMessage.card_number ? 'red' : '' }}
                                        ...
                                        type="number"
                                        name="card_number"
                                        onClick={() => setErrorMessage({ ...errorMessage, cart_number: '' })}
                                        onChange={inputChange}
                                        title="Inpit title"
                                ...
                                <div className="input_container">
                                    <label style={{ color: errorMessage.expiry_date ? 'red' : '' }} >
                                        Expiry Date / CVV
                                    </label>
                                    <div className="split">
                                        <input
                                            style={{ width: '100%', borderColor: errorMessage.expiry_date ? 'red' : '' }}
                                            className="input_field"
                                            type="number"
                                            name="expiry_date"
                                            onClick={() => setErrorMessage({ ...errorMessage, expiry_date: '' })}
                                            onChange={inputChange}
                                            title="Expiry Date"
                                            placeholder="01/23"
                                        />
                                        <input
                                            style={{ width: '100%', borderColor: errorMessage.cvv ? 'red' : '' }}
                                            className="input_field"
                                            type="number"
                                            name="cvv"
                                            onClick={() => setErrorMessage({ ...errorMessage, cvv: '' })}
                                            onChange={inputChange}
                                            title="CVV"
                                            placeholder="CVV"
                                        />
